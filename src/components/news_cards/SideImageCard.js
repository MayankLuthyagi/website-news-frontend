...
function SideImageCard({ id, title, summary, url, date, source_id, source_name, category, subcategory, image }) {
    ...
    return (
        <a
            ...
            tabIndex={0}
        >
            <div className="side-image-card-image">
                {imageUrl && (
                    <img
                        src={imageUrl}
                        alt={sourceName}
                ...
                {!imageUrl && (
                    <div className="side-image-card-no-image">
                        <span>{sourceName.charAt(0).toUpperCase()}</span>
                    </div>
                )}
            </div>

            <div className="side-image-card-content">
                <h4 className="side-image-card-title">{title}</h4>
                <span className="side-image-card-source">{sourceName}</span>
            </div>
        </a>
    );
}
